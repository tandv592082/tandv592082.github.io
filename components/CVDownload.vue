    ...
    <div class="flex items-center">
        ...
        <Menu as="div" class="relative inline-block text-left" v-if="!isLoading">
            ...
            <transition enter-active-class="transition duration-100 ease-out"
                ...
                <MenuItems
                    class="absolute right-0 <sm:right-1/2 <sm:transform <sm:translate-x-1/2 bg-white dark:bg-black dark:border  dark:border-gray-800 mt-2 w-56 origin-top-right divide-y divide-gray-100 dark:divide-gray-800 rounded-md  shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
