        ...
        <Menu as="div" class="relative inline-block text-left  dark:bg-dark">
            <div>
                <MenuButton
                    ...
                    <Icon name="fluent:local-language-zi-24-regular" size="24" class="cursor-pointer" />
                </MenuButton>
            </div>
            ...
            <transition enter-active-class="transition duration-100 ease-out"
                ...
                <MenuItems
                    class="absolute bg-white dark:bg-black dark:border dark:border-gray-800 right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 dark:divide-gray-800 rounded-md  shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div class="py-2 ">
